...
[![Live Demo](https://img.shields.io/badge/Live_Demo-auxweaver.vercel.app-22c55e.svg)](https://auxweaver.vercel.app/)
...
🌐 **Live Application**: [https://auxweaver.vercel.app/](https://auxweaver.vercel.app/)
...
npm run dev
```
Open **`https://auxweaver.vercel.app/`** (or your local dev server at `http://localhost:3300`). Click **New Canvas** or open an existing design from `/files`.
...
2. Open Auxweave live at [**`https://auxweaver.vercel.app/create`**](https://auxweaver.vercel.app/create) (or `http://localhost:3300/create` locally).
