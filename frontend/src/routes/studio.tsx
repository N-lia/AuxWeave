...
const releasePageHref = 'https://github.com/striker561/Auxweave-Studio/releases/latest'

const studioRepoHref = 'https://github.com/striker561/Auxweave-Studio'

const studioBranchHref = 'https://github.com/striker561/Auxweave-Studio/tree/studio'
...
const downloadLinks = [
  {
    ...
    href: 'https://github.com/striker561/Auxweave-Studio/releases/latest/download/Auxweave-studio-windows-amd64-installer.exe',
    icon: WindowsNewIcon,
    badge: 'Latest',
  },
  {
    ...
    href: 'https://github.com/striker561/Auxweave-Studio/releases/latest/download/Auxweave-studio-macos-arm64.dmg',
    icon: AppleIcon,
    badge: 'Recommended',
  },
  {
    ...
    href: 'https://github.com/striker561/Auxweave-Studio/releases/latest/download/Auxweave-studio-macos-amd64.dmg',
    icon: AppleIcon,
    badge: 'Intel only',
  },
  {
    ...
    href: 'https://github.com/striker561/Auxweave-Studio/releases/latest/download/Auxweave-studio-linux-amd64',
...
const capabilityCards = [
  ...
  },
  {
    ...
    body: 'You still get the Auxweave editing flow, but with native open, save, and export behavior around it.',
  },
  {
    eyebrow: 'Releases',
        ...
        <div className="relative z-1 mx-auto w-full max-w-3xl">
          <div className="rise-in text-left">
            ...
            <p className="mb-10 max-w-xl text-lg leading-[1.6] text-(--text-muted) sm:mb-12 sm:text-xl sm:leading-[1.55] lg:text-[1.375rem] lg:leading-normal">
              Auxweave Studio is the desktop fork of Auxweave. It packages the editor as a native app for
            ...
            <div className="mt-10 rounded-[1.6rem] border border-black/8 bg-white/72 p-5 shadow-[0_18px_50px_rgba(15,23,42,0.05)] backdrop-blur-md">
              ...
              <p className="mt-3 text-[15px] leading-7 text-(--text-muted)">
                Auxweave Studio is independently maintained by{' '}
                <a
                ...
                or the upstream Auxweave project.
              </p>
            ...
            <details className="group">
              <summary className="flex cursor-pointer list-none items-start justify-between gap-4">
                <div>
                  ...
                  <p className="mt-2 max-w-3xl text-sm leading-6 text-(--text-muted)">
                    If macOS blocks Auxweave Studio from opening, the app is not yet signed with Apple.
              ...
              <div className="mt-5 space-y-5 border-t border-black/8 pt-5">
                <div>
                  ...
                  <ol className="mt-2 list-decimal space-y-1.5 pl-5 text-sm leading-6 text-(--text-muted)">
                    <li>Locate Auxweave.app in Finder</li>
                ...
                <div>
                  ...
                  <ol className="mt-2 list-decimal space-y-1.5 pl-5 text-sm leading-6 text-(--text-muted)">
                    ...
                    <li>Click Allow Anyway next to Auxweave Studio</li>
                ...
                <div>
                  ...
                  <pre className="mt-2 overflow-x-auto rounded-xl border border-black/8 bg-[#111111] px-4 py-3 text-sm text-white">
                    <code>xattr -rd com.apple.quarantine /Applications/Auxweave.app</code>
                  </pre>
                  <p className="mt-2 text-sm leading-6 text-(--text-muted)">
                ...
                <table className="w-full min-w-2xl border-collapse text-left">
                  <thead className="bg-black/3 text-sm text-(--text-subtle)">
                    <tr>
                      ...
                      <th className="px-5 py-4 font-medium">Auxweave Studio</th>
                      <th className="px-5 py-4 font-medium">Auxweave web</th>
                    </tr>
                  </thead>
                  <tbody>
      ...
      <section className="landing-section">
        <div className="landing-container">
          <div className="landing-section-heading">
            ...
            <p className="landing-section-copy">
              Studio keeps the Auxweave editor familiar while making the surrounding workflow feel like
