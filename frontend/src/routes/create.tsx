        ...
        <div className="relative z-[1] mx-auto flex w-full max-w-2xl flex-1 items-center justify-center">
          <div className="w-full rounded-[2rem] border border-[var(--line)] bg-white/82 p-7 text-center shadow-[0_24px_80px_rgba(0,0,0,0.08)] backdrop-blur-md sm:p-10">
            ...
            <Text className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-[var(--text-muted)] sm:text-lg">
              Open Auxweave on a desktop or laptop to create and edit files. You can still return to
    ...
    <div className="flex h-[100dvh] min-h-0 flex-col bg-[var(--surface-subtle)]">
      <header className="flex flex-shrink-0 items-center gap-3 border-b border-[var(--line)] bg-[var(--surface)] px-4 py-3 sm:px-5 sm:py-3.5">
        ...
        <div className="min-w-0 flex-1">
          <label htmlFor="auxweave-doc-title" className="sr-only">
            Document name
          </label>
          <input
            id="auxweave-doc-title"
            type="text"
            value={documentTitle}
      ...
      <DocumentMigrationDialog
        ...
        message={`"${documentTitle}" was made in an older version of Auxweave. Convert it to the new editor before you keep editing.`}
        ...
        onConfirm={() => {
          ...
          void (async () => {
            try {
              ...
              console.error('[Auxweave] legacy migration failed', err)
            } finally {
