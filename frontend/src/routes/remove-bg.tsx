...
import { removeBackgroundFromFile } from '../lib/auxweave-background-removal'
...
const SPONSOR_PROMPT_STORAGE_KEY = 'auxweave-remove-bg-sponsor-prompt-dismissed'
      ...
      >
        <div className="bg-[linear-gradient(135deg,#fff6dd,#ffe8f1_48%,#eef8ff)] px-6 pb-6 pt-7 sm:px-8 sm:pb-7">
          ...
          <p className="mt-4 max-w-[28rem] text-base font-medium leading-7 text-[#555f6b] sm:text-lg">
            Your download is ready. If Auxweave saved you time, a small sponsorship helps keep fast,
          ...
          {originalUrl ? (
            ...
            >
              ...
              <img
                ...
                alt="Original image"
                className={cx(
                  'auxweave-remove-bg-original-layer absolute inset-0 h-full w-full object-contain',
                  showOriginal && 'is-visible',
                )}
                draggable={false}
              />
              {processing ? (
                <div className="auxweave-remove-bg-overlay pointer-events-none absolute inset-0 overflow-hidden rounded-2xl">
