import { samplePenAnchorsToPolyline, type VectorPenAnchor } from './auxweave-vector-pen-bezier'

export const VECTOR_BOARD_DOC_VERSION = 2 as const

export const Auxweave_VECTOR_BOARD_DRAG_MIME = 'application/Auxweave-vector-board'
...
export function parseVectorStrokeClipboardText(text: string): VectorBoardStroke[] | null {
  ...
  if (o.AuxweaveVectorStrokeClip !== true || o.v !== 1 || !Array.isArray(o.strokes)) return null
  const out: VectorBoardStroke[] = []
