...
const ITEMS: Item[] = [
  ...
  },
  {
    id: 'moodboard',
    label: 'Moodboard',
    icon: editorSidebarIcons.moodboard.icon,
    activeIcon: editorSidebarIcons.moodboard.activeIcon,
  },
  {
    id: 'apps',
    label: 'Apps',
        ...
        if (item.fancy) {
          return (
            <button
              ...
              className={[
                'auxweave-ai-tile relative z-10 flex w-[4.25rem] flex-col items-center gap-1 rounded-2xl px-1.5 py-2.5 text-[11px] font-medium transition-[background,box-shadow]',
            ...
            >
              <HugeiconsIcon
                ...
                className="auxweave-ai-accent shrink-0"
              />
              <span className="auxweave-ai-accent max-w-full truncate font-semibold">
                {item.label}
              </span>
            </button>
          )
