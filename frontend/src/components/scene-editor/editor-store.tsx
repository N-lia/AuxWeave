...
import { type AuxweaveDocument, syncActivePage } from '../../lib/auxweave-scene'
...
export type EditorStoreState = {
  ...
  selectedIds: string[]
  setDoc: (next: EditorSetter<AuxweaveDocument>) => void
...
export function createEditorStore(initialDoc: AuxweaveDocument): EditorStoreApi {
