...
import { type AuxweaveDocument, cloneAuxweaveDocument } from '../../lib/auxweave-scene'
...
export function useEditorKeyboardShortcuts({
  ...
  useEffect(() => {
    const restoreHistorySnapshot = (nextIndex: number) => {
      ...
      setDoc(cloneAuxweaveDocument(snap))
      window.setTimeout(() => {
