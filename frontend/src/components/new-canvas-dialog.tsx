    ...
    >
      ...
      >
        ...
        <p className="mt-2 max-w-2xl text-[15px] leading-relaxed text-[var(--text-muted)]">
          {editorUnsupported
            ? "Auxweave's editor is not available on mobile devices yet. Open this app on a desktop or laptop to create a new canvas."
            ...
            {mode === 'presets' ? (
              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3 rounded-[1.4rem] border border-black/[0.08] bg-black/[0.02] p-4">
                  ...
                  <div>
                    <label
                      htmlFor="auxweave-new-canvas-h"
                      className="mb-1.5 block text-xs font-medium uppercase tracking-wide text-[var(--text-subtle)]"
                    >
                      Height
                    </label>
                    <input
                      id="auxweave-new-canvas-h"
                      type="text"
                      inputMode="numeric"
                      value={customH}
