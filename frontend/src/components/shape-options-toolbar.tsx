...
import {
  type ArrowLineStyle,
  type ArrowPathType,
  type AuxweaveShapeMeta,
  isAuxweaveStrokeLineLike,
} from '../lib/auxweave-shape-meta'
...
export default function ShapeOptionsToolbar({
  ...
  if (meta.kind === 'line' && !isAuxweaveStrokeLineLike(meta)) {
    return (
  ...
  if (isAuxweaveStrokeLineLike(meta)) {
